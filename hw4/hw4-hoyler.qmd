...
# x = output
# look at overall output? gs sensitvity to uncertainty
...
Total indices includes interaction. 
What does second order mean? More interaction stuff based on S2 object...
Second order the same except! You use scheme='B'
